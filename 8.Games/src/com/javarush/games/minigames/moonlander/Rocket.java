...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        leftFire = new RocketFire(Arrays.asList(ShapeMatrix.LEFT_FIRE_SIDE_1, ShapeMatrix.LEFT_FIRE_SIDE_2,  ShapeMatrix.LEFT_FIRE_SIDE_3));
        rightFire = new RocketFire(Arrays.asList(ShapeMatrix.RIGHT_FIRE_SIDE_1, ShapeMatrix.RIGHT_FIRE_SIDE_2, ShapeMatrix.RIGHT_FIRE_SIDE_3));
    }
    ...
    private void switchFire(boolean isUpPressed, boolean isLeftPressed, boolean isRightPressed) {
        ...
        if (isRightPressed) {
            rightFire.x = x - ShapeMatrix.RIGHT_FIRE_SIDE_1[0].length;
