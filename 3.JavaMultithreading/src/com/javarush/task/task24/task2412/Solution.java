    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                if (((String) stock1.get("name")).compareTo((String)stock2.get("name")) == 0) {
                    if (((Date) stock1.get("date")).compareTo(((Date) stock2.get("date"))) == 0) {
                        double first = !stock1.containsKey("change") ? (double) stock1.get("open") - (double) stock1.get("last") : (double) stock1.get("change");
                        double second = !stock2.containsKey("change") ? (double) stock2.get("open") - (double) stock2.get("last") : (double) stock2.get("change");
                        return -Double.compare(first, second);
                    } else
                        return -((Date) stock1.get("date")).compareTo(((Date) stock2.get("date")));
                } else
